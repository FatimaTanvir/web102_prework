...
const formatContributions = totalContributions.toLocaleString();
...
const formatRaised = `$${totalRaised.toLocaleString()}`;
raisedCard.innerHTML = `${formatRaised}`;
...
A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games.  Currently, ${numUnfunded} ${numUnfunded === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!
`;
